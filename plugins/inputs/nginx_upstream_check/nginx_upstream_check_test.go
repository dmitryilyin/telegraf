...
{"servers": {
  ...
  "generation": 1,
  "server": [
    {"index": 0, "upstream": "upstream-1", "name": "127.0.0.1:8081", "status": "up", "rise": 1000, "fall": 0, "type": "http", "port": 0},
    {"index": 1, "upstream": "upstream-2", "name": "127.0.0.1:8082", "status": "down", "rise": 0, "fall": 2000, "type": "tcp", "port": 8080}
  ]
}}
`

func TestNginxUpstreamCheck(test *testing.T) {
	...
	check := &NginxUpstreamCheck{
		Urls: []string{fmt.Sprintf("%s/status", testServer.URL)},
	}
